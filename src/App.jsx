...
// Títulos completos para la navegación interna
...
const App = () => {
  ...
  const tracks = {
    "APRENDIZAJE": [
      ...
      { name: "Beta Learning", hz: "12 – 14 Hz", url: "/audio/beta-learning.mp3", desc: "Favorece la absorción pasiva de información y el aprendizaje sin esfuerzo." },
