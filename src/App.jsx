  ...
  return (
    <div style={{ backgroundColor: '#020617', minHeight: '100vh', color: 'white', padding: '15px', fontFamily: 'sans-serif', overflowX: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {/* 🧱 ADN CON RESPLANDOR INTERNO REFORZADO AL MÁXIMO (drop-shadow x4) */}
        <div style={{ 
          ...
          boxShadow: `0 0 50px ${accentColor}44` // Suave toque exterior para difuminar
        }}>
          <img 
            ...
            style={{ 
              ...
              objectFit: 'cover', 
              borderRadius: '50%',
              // 💡 EL TRUCO MULTIPLICADO: Cuatro capas de resplandor para intensidad supernova
              filter: `
                drop-shadow(0 0 10px ${accentColor}) 
                drop-shadow(0 0 20px ${accentColor}) 
                drop-shadow(0 0 40px ${accentColor}88) 
                drop-shadow(0 0 60px ${accentColor}44)
              `,
        ...
        <div style={{ width: '100%', marginBottom: '45px', display: 'flex', justifyContent: 'center' }}>
          <input 
            ...
            style={{ 
              ...
              padding: '12px 20px', color: 'white', fontSize: '12px', outline: 'none',
        ...
        {/* BOTONES OVALADOS DINÁMICOS CON INTERACCIÓN */}
