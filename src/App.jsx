...
const inlineStyles = `
  ...
  /* ESCÁNDALO DE LUZ: Supernova Externa */
  ...
  /* RESPIRACIÓN DEL FOCO CENTRAL (Efecto Zen) */
  @keyframes adn-inner-glow {
    0%, 100% { filter: drop-shadow(0 0 15px rgba(34, 211, 238, 0.4)); transform: scale(1); }
    50% { filter: drop-shadow(0 0 40px rgba(34, 211, 238, 0.9)); transform: scale(1.05); }
  }
...
const App = () => {
  ...
  useEffect(() => {
    // Intentamos disparar el sonido startup con un poco más de ganancia
    if (startupAudioRef.current) {
      startupAudioRef.current.volume = 1.0; 
      startupAudioRef.current.play().catch(e => console.log("Sonido esperando activación manual"));
    }
  ...
  if (selectedTrack) {
    return (
      <div className="fade-in-smooth" style={{ backgroundColor: '#020617', minHeight: '100vh', color: 'white', padding: '15px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative' }}>
        ...
        {/* ADN REPRODUCTOR: Respiración Central Activa */}
        <div style={{ 
          ...
          <img src="/imagenes/adn-icon.png" style={{ width: '100%', height: '100%', objectFit: 'contain', animation: 'adn-inner-glow 4s infinite ease-in-out' }} alt="ADN" />
        </div>
  ...
  return (
    <div className="fade-in-smooth" style={{ backgroundColor: '#020617', minHeight: '100vh', color: 'white', padding: '15px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {/* ADN LISTA: Respiración Central Suave */}
        <div style={{ 
          ...
          <img src="/imagenes/adn-icon.png" style={{ width: '100%', height: '100%', objectFit: 'contain', animation: 'adn-inner-glow 6s infinite ease-in-out' }} alt="ADN" />
        </div>
