...
const App = () => {
  ...
  // --- BLINDAJE TÉCNICO DE SONIDO ---
  // Este bloque asegura que el audio se cargue y reproduzca al seleccionar una pista
  useEffect(() => {
    if (audioRef.current && selectedTrack) {
      audioRef.current.load(); // Carga la nueva ruta
      if (isPlaying) {
  ...
  // --- PANTALLA 2: REPRODUCTOR (BLINDADO) ---
  if (selectedTrack) {
    return (
