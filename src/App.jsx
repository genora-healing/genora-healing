...
const inlineStyles = `
  ...
  @keyframes etherealWave {
    ...
    100% { transform: scale(2.7) rotate(200deg); opacity: 0; }
  ...
  .templo-wave-ring {
    ...
    filter: url(#etherealWaveFilter) blur(2.5px);

    box-shadow: 0 0 20px 9px rgba(34,211,238,0.8), 0 0 55px 22px rgba(34,211,238,0.45), 0 0 110px 42px rgba(34,211,238,0.2);
      ...
      <div key={selectedTrack.id} className="fade-in-smooth" style={{ backgroundColor: '#020617', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative', padding: '20px' }}>
        ...
        <svg style={{ position: 'absolute', width: 0, height: 0, pointerEvents: 'none' }}>
          ...
          <filter id="etherealWaveFilter">
            ...
            <feTurbulence type="turbulence" baseFrequency="0.022 0.01" numOctaves="3" result="noise" seed="5" />
