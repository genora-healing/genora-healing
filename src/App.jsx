...
const inlineStyles = `
  ...
  @keyframes aura-supernova {
    ...
    50% {
      ...
      box-shadow: 0 0 120px 0 rgba(34, 211, 238, 0.6), 0 0 280px 0 rgba(34, 211, 238, 0.35), 0 0 480px 0 rgba(34, 211, 238, 0.15);
  ...
  @keyframes aura-violet {
    ...
    50% {
      ...
      box-shadow: 0 0 120px 0 rgba(124, 92, 230, 0.6), 0 0 280px 0 rgba(124, 92, 230, 0.35), 0 0 480px 0 rgba(79, 61, 161, 0.15);
  ...
  @keyframes aura-gold {
    ...
    50% {
      ...
      box-shadow: 0 0 120px 0 rgba(212, 175, 55, 0.6), 0 0 280px 0 rgba(212, 175, 55, 0.35), 0 0 480px 0 rgba(212, 175, 55, 0.15);
...
const App = () => {
  ...
  const ADNOrb = ({ auraClass = 'aura-supernova', filterClass = 'logo-normal', size = '110px' }) => (
    ...
    <div style={{ width: size, height: size, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px', position: 'relative', overflow: 'visible' }}>
      ...
      <img src="/imagenes/adn-icon.png" className={filterClass} style={{ width: '62%', objectFit: 'contain', borderRadius: '50%', background: 'rgba(2,6,23,0.92)', padding: '2%', position: 'relative', zIndex: 2, animation: `${auraClass} 5s ease-in-out infinite`, transition: 'all 0.5s ease' }} alt="ADN" />
