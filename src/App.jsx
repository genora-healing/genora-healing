...
const inlineStyles = `
  ...
  @keyframes etherealWave {
    0% {
      ...
      filter: drop-shadow(0 0 12px rgba(0, 243, 255, 1))
              drop-shadow(0 0 28px rgba(0, 243, 255, 0.85))
              drop-shadow(0 0 50px rgba(0, 243, 255, 0.6));
    }
    35% {
      transform: scale(1.4) rotate(32deg);
      opacity: 0.75;
      filter: drop-shadow(0 0 20px rgba(0, 243, 255, 0.95))
              drop-shadow(0 0 50px rgba(0, 243, 255, 0.75))
              drop-shadow(0 0 90px rgba(0, 243, 255, 0.45));
    }
    70% {
      transform: scale(2.2) rotate(63deg);
      opacity: 0.35;
      filter: drop-shadow(0 0 28px rgba(0, 243, 255, 0.8))
              drop-shadow(0 0 70px rgba(0, 243, 255, 0.5))
              drop-shadow(0 0 120px rgba(0, 243, 255, 0.25));
    }
    100% {
      transform: scale(2.7) rotate(90deg);
      opacity: 0;
      filter: drop-shadow(0 0 35px rgba(0, 243, 255, 0))
              drop-shadow(0 0 90px rgba(0, 243, 255, 0));
    }
  }
  ...
  .templo-wave-path {
    ...
    filter: drop-shadow(0 0 12px rgba(0, 243, 255, 1)) drop-shadow(0 0 28px rgba(0, 243, 255, 0.85)) drop-shadow(0 0 50px rgba(0, 243, 255, 0.6));
