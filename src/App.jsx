...
const inlineStyles = `
  ...
  /* --- MICRO-AJUSTE AUTORIZADO: TAMAÑO DE BOTONES FINOS --- */
  .frecuencia-card {
    ...
    text-align: center;
    cursor: pointer;
    min-height: 60px !important; /* Altura sutil blindada */
  ...
  if (selectedTrack) {
    return (
      <div className="fade-in-smooth" style={{ backgroundColor: '#020617', minHeight: '100vh', color: 'white', padding: '15px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative' }}>
        ...
        {/* REPRODUCTOR: BOTÓN VOLVER CIRCULAR - FLECHA CYAN */}
        ...
        {/* MISIÓN 1 CUMPLIDA: ADN CENTRAL CIRCULAR (BORDER-RADIUS: 50%) */}
        <div style={{ width: '210px', height: '210px', backgroundColor: '#000', borderRadius: '50% !important', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '40px', animation: isPlaying ? 'aura-supernova 4s infinite ease-in-out' : 'none', boxShadow: '0 0 100px rgba(34, 211, 238, 0.3)', overflow: 'hidden' }}>
          <img src="/imagenes/adn-icon.png" style={{ width: '120%', filter: 'drop-shadow(0 0 40px #22d3ee)', borderRadius: '50% !important' }} />
        </div>
        ...
        {/* MISIÓN 2 CUMPLIDA: BOTÓN PLAY CON ICONO BLANCO */}
  ...
  return (
    <div className="fade-in-smooth" style={{ backgroundColor: '#020617', minHeight: '100vh', color: 'white', padding: '15px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {/* ADN CIRCULARIZADO EN LISTAS */}
        <div style={{ width: '150px', height: '150px', borderRadius: '50% !important', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '30px', animation: 'aura-supernova 8s infinite ease-in-out', overflow: 'hidden' }}>
          <img src="/imagenes/adn-icon.png" style={{ width: '125%', filter: 'drop-shadow(0 0 10px #22d3ee)', borderRadius: '50% !important' }} />
        </div>
