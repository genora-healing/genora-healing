...
const inlineStyles = `
  ...
  .templo-wave-path {
    ...
    filter: drop-shadow(0 0 6px rgba(0, 243, 255, 0.65));
    transform-box: fill-box;
    transform-origin: 50% 50%;
    animation: expandWave 4.8s cubic-bezier(0.25, 1, 0.5, 1) infinite;
  }
  .templo-sparkle {
    position: absolute;
    width: 5px;
