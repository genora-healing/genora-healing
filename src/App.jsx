  ...
  return (
    <div style={{ backgroundColor: '#020617', minHeight: '100vh', color: 'white', padding: '15px', fontFamily: 'sans-serif', overflowX: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {/* 🧱 ADN CON PRECARGA PARA EVITAR PARPADEO */}
        <div style={{ 
          ...
          animation: adnLoaded ? 'breathe 4s infinite ease-in-out' : 'none',
          boxShadow: adnLoaded ? `0 0 50px ${accentColor}44` : 'none',
          ...
          <img 
            ...
            style={{ 
              ...
              filter: `
                ...
                drop-shadow(0 0 25px ${accentColor}) 
                drop-shadow(0 0 45px ${accentColor}aa) 
                drop-shadow(0 0 70px ${accentColor}66)
              `
            }} 
            alt="ADN Radiante" 
          />
        ...
        <div style={{ width: '100%', marginBottom: '45px', display: 'flex', justifyContent: 'center' }}>
          <input 
            ...
            style={{ 
              ...
              padding: '12px 20px', color: 'white', fontSize: '12px', textAlign: 'center', letterSpacing: '3px', outline: 'none'
            }} 
          />
        </div>
